#!/usr/bin/env python3
"""
NOVA-X Patch Synthesis Engine v5.0 — force branch reset
"""
...
# ============================================================
# GIT + CURL ENGINE (with force branch reset)
# ============================================================
...
class GitCurlEngine:
    ...
    def create_pr(self, title, body):
        ...
        # Delete remote branch if it exists (ignore failure)
        self._run(f"git push origin --delete {self.head} 2>/dev/null || true")

        # Force-create / reset local branch from current HEAD (which has patches)
