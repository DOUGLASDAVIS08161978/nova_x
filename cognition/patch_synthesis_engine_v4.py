#!/usr/bin/env python3
"""
NOVA-X Patch Synthesis Engine v4.0 — Git-first workflow
"""

import os, re, json, uuid, subprocess, sys
...
class GitCurlEngine:
    ...
    def create_pr(self, title, body):
        ...
        # Ensure we are on a clean state: stash any uncommitted changes
        # but we don't want to lose them; we will commit them.
        # Actually, we already applied patches, so we want to commit them.
        # Create a new branch from the current HEAD (which may have patches)
...
"""
    ...
    print("🚀 Creating branch, committing changes, and opening pull request...")
