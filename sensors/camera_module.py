...
"""
===========================================================
NOVA-X Camera Module v1.1
===========================================================

Connects NOVA-X to Android camera through Termux:API.

Features:
- Camera registration with SensorManager
- Image capture
- Local image storage
...
class CameraModule:
    ...
    def __init__(self, sensor_manager=None):
        ...
        # Register camera with Sensor Manager
        if "camera" not in self.sensor_manager.sensors:

            self.sensor_manager.register_sensor(
                "camera",
                "Android Camera via Termux API"
            )
